        ...
        userForm: function () {
            ...
            if (c.append(p), a.agreement.isRequired) {
                ...
                r = a.agreement.isLink ? t("<a>").attr({
                    ...
                    class: "smart-basket__link-agreement"
                }), s.is(":checked") ? r.text("Оплатить") : r.text("Оплатить"), e.click(function () {
                    s.is(":checked") ? (r.text("Оплатить"), s.val("Оплатить"), m.attr({
                        disabled: "disabled"
                    }), d.addClass("smart-basket__input-wrapper_error")) : (r.text("Оплатить"), s.val("Оплатить"), m.attr({
                        disabled: !1
